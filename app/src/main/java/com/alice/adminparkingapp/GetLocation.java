...
import com.alice.adminparkingapp.Model.LocationHelper;
...
//        Intent intent = new Intent(GetLocation.this, Lokasi.class);
                ...
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        ...
                        if (task.isSuccessful()) {
                            Toast.makeText(GetLocation.this, "Lokasi tersimpan", Toast.LENGTH_SHORT).show();
                        }else {
                            Toast.makeText(GetLocation.this, "Lokasi tidak tersimpan", Toast.LENGTH_SHORT).show();
                        }
